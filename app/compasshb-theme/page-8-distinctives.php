...
<div class="container-fluid" style="background-color: #f7f7f7;border-color: #e4e4e4;border-style: solid;border-width: 1px 0 0 0;">
	
	<div class="row">
		<div class="container">
			<h1>8 Distinctives</h1>
			<p>At Compass Bible Church we are called to make disciples of Christ (Matthew 28:18-20). As we do, we will always work to express and maintain these eight ministry values.</p>
		</div>
	</div>
		
	<div class="row">
		<div class="container">
			<div class="col-md-6" style="background-color: #FFF; width: 45%; margin: 15px;">
