	...
	*/
	...
	function init()
	{
		...
		$scripts[] = array(
			...
			'src'		=> "/wp-content/plugins/compasshb-plugin/lib/advanced-custom-fields/js/field-group{$min}.js",
			'deps'		=> array('jquery')
		);
		$scripts[] = array(
			'handle'	=> 'acf-input',
			'src'		=> "/wp-content/plugins/compasshb-plugin/lib/advanced-custom-fields/js/input{$min}.js",
		...
		// register acf styles
		$styles = array(
			'acf'				=> '/wp-content/plugins/compasshb-plugin/lib/advanced-custom-fields/css/acf.css',
			'acf-field-group'	=> '/wp-content/plugins/compasshb-plugin/lib/advanced-custom-fields/css/field-group.css',
			'acf-global'		=> '/wp-content/plugins/compasshb-plugin/lib/advanced-custom-fields/css/global.css',
			'acf-input'			=> '/wp-content/plugins/compasshb-plugin/lib/advanced-custom-fields/css/input.css',
			'acf-datepicker'	=> '/wp-content/plugins/compasshb-plugin/lib/advanced-custom-fields/core/fields/date_picker/style.date_picker.css',
		);
