...
@section('content')
    ...
    <div class="col-md-5  well" >
        ...
        <h3 class="tk-seravek-web">3. WE SEEK TO MAINTAIN A HIGH VIEW OF GOD</h3>
    ...
    <div class="col-md-5 col-md-offset-1 well" >
        ...
        <h3 class="tk-seravek-web">4. WE WORK TO PROCLAIM A BIBLICAL GOSPEL</h3>
    ...
    <div class="col-md-5 well">
        ...
        <h3 class="tk-seravek-web">5. WE HAVE A GENUINE RELIANCE ON PRAYER</h3>
    ...
    <div class="col-md-5 col-md-offset-1 well" >
        ...
        <h3 class="tk-seravek-web">6. WE HAVE HIGHLY COMMITTED PARTICIPANTS</h3>
        ...
        <p>Ephesians 4:11-16; Acts 4:34-35<br/><br/><br/><br/></p>
    </div>
    <div class="col-md-5 well" >
        <center><span class="glyphicon glyphicon-ok" aria-hidden="true"></span></center>
        <h3 class="tk-seravek-web">7. WE WILL LOOK TO AUTHENTIC AND SACRIFICIAL LEADERS</h3>
    ...
    <div class="col-md-5 col-md-offset-1 well" >
        ...
        <h3 class="tk-seravek-web">8. WE WILL ALWAYS BE WORKING TO PLANT NEW CHURCHES</h3>
